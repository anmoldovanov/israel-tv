...
/***/ (function(module, exports, __webpack_require__) {
	...
	var bowser = __webpack_require__(5);
	...
	var Tablist = __webpack_require__(8);
	var Toggler = __webpack_require__(10);
	Tablist.initAll();
	Toggler.initAll();

	var MicroModal = __webpack_require__(11); // commonjs module
	...
	var Bee3D = __webpack_require__(12);
...
/***/ (function(module, exports) {
	...
	!function (e, t, n) {
	  function r(e, t) {
	    ...
	    var e, t, n, s, o, i, a;for (var l in x) {
	    ...
	    var o,
	      ...
	      f = i("div"), f.id = s ? s[r] : p + (r + 1), d.appendChild(f);
	    ...
	    function l() {
	      ...
	      var f = y(e, s);if (!r(f, "undefined")) return f;
	    }for (var p, d, c, v, m, h = ["modernizr", "tspan", "samp"]; !L.style && h.length;) {
	      p = !0, L.modElem = i(h.shift()), L.style = L.modElem.style;
	    }for (c = e.length, d = 0; c > d; d++) {
	      if (v = e[d], m = L.style[v], u(v, "-") && (v = a(v)), L.style[v] !== n) {
	        if (o || r(s, "undefined")) return l(), "pfx" == t ? v : !0;try {
	          L.style[v] = s;
	        } catch (g) {}if (L.style[v] != m) return l(), "pfx" == t ? v : !0;
	      }
	    }return l(), !1;
	  }function m(e, t, n, s, o) {
	    var i = e.charAt(0).toUpperCase() + e.slice(1),
	        a = (e + " " + j.join(i + " ") + i).split(" ");return r(t, "string") || r(t, "undefined") ? v(a, t, s, o) : (a = (e + " " + P.join(i + " ") + i).split(" "), d(a, t, n));
	  }function h(e, t, r) {
	    return m(e, n, n, t, r);
	  }var g = [],
	      x = [],
	      ...
	      Modernizr = function Modernizr() {};Modernizr.prototype = C, Modernizr = new Modernizr(), Modernizr.addTest("picture", "HTMLPictureElement" in e), Modernizr.addTest("es6array", !!(Array.prototype && Array.prototype.copyWithin && Array.prototype.fill && Array.prototype.find && Array.prototype.findIndex && Array.prototype.keys && Array.prototype.entries && Array.prototype.values && Array.from && Array.of)), Modernizr.addTest("fetch", "fetch" in e);var T = t.documentElement;Modernizr.addTest("classlist", "classList" in T);var S = "svg" === T.nodeName.toLowerCase();Modernizr.addTest("csspointerevents", function () {
	  ...
	  });var b = C._config.usePrefixes ? " -webkit- -moz- -o- -ms- ".split(" ") : ["", ""];C._prefixes = b, Modernizr.addTest("csscalc", function () {
	    var e = "width:",
	        t = "calc(10px);",
	        n = i("a");return n.style.cssText = e + b.join(t + e), !!n.style.length;
	    ...
	    var e = "position:",
	      ...
	      _ = "supportsCSS" in e;Modernizr.addTest("supports", w || _);var A = C.testStyles = f;A("#modernizr { height: 50vh; }", function (t) {
	    var n = parseInt(e.innerHeight / 2, 10),
	      ...
	      j = C._config.usePrefixes ? k.split(" ") : [];C._cssomPrefixes = j;var E = function E(t) {
	    var r,
	        s = b.length,
	        o = e.CSSRule;if ("undefined" == typeof o) return n;if (!t) return !1;if (t = t.replace(/^@/, ""), r = t.replace(/-/g, "_").toUpperCase() + "_RULE", r in o) return "@" + t;for (var i = 0; s > i; i++) {
	      var a = b[i],
	          l = a.toUpperCase() + "_" + r;if (l in o) return "@-" + a.toLowerCase() + "-" + t;
	    }return !1;
	  };C.atRule = E;var P = C._config.usePrefixes ? k.toLowerCase().split(" ") : [];C._domPrefixes = P;var z = { elem: i("modernizr") };Modernizr._q.push(function () {
	    delete z.elem;
	  });var L = { style: z.elem.style };Modernizr._q.unshift(function () {
	    delete L.style;
	  }), C.testAllProps = m, C.testAllProps = h, Modernizr.addTest("backdropfilter", h("backdropFilter")), Modernizr.addTest("cssfilters", function () {
	    if (Modernizr.supports) return h("filter", "blur(2px)");var e = i("a");return e.style.cssText = b.join("filter:blur(2px); "), !!e.style.length && (t.documentMode === n || t.documentMode > 9);
	  }), Modernizr.addTest("flexboxlegacy", h("boxDirection", "reverse", !0)), Modernizr.addTest("flexwrap", h("flexWrap", "wrap", !0)), Modernizr.addTest("cssmask", h("maskRepeat", "repeat-x", !0)), Modernizr.addTest("shapes", h("shapeOutside", "content-box", !0));var N = C.prefixed = function (e, t, n) {
	    return 0 === e.indexOf("@") ? E(e) : (-1 != e.indexOf("-") && (e = a(e)), t ? m(e, t, n) : m(e, "pfx"));
	  };Modernizr.addTest("objectfit", !!N("objectFit"), { aliases: ["object-fit"] }), s(), o(g), delete C.addTest, delete C.addAsyncTest;for (var O = 0; O < Modernizr._q.length; O++) {
	    Modernizr._q[O]();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _require = __webpack_require__(9),
	    ...
	    getDatasetBoolean = _require.getDatasetBoolean,
	    replaceHash = _require.replaceHash,
	    guid = _require.guid,
	    setOpts = _require.setOpts;
	...
	var Tablist = function () {
	    function Tablist(tablist) {
	        ...
	        forEach(tablist.querySelectorAll('[data-tablist-tab]'), function (tab) {

	            var panel = document.getElementById(tab.dataset.tablistTab);

	            if (!panel && _this.opts.siblingPanel) {
	            ...
	            var item = tab.closest('[data-tablist-item]') || tab.parentNode;
	            ...
	            _this.tabs.set(tab.id, tab);
	            _this.items.set(tab, item);
	            _this.panels.set(tab, panel);
	            ...
	            var active = tab.classList.contains(_this.opts.classTabActive);

	            // Устанавливаем состояния для веб-доступности
	            setStatusAria(_this.opts, tab, panel, active);
	            ...
	            var closeElem = panel.querySelector('[data-close]');
	            if (closeElem) {
	    ...
	    _createClass(Tablist, [{
	        ...
	        value: function toggle(tab) {
	            ...
	            var s = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : !tab.classList.contains(this.opts.classTabActive);
	            // если действие не указано, проверяем, активный ли элементы и закрываем (и наоборот)
	            ...
	            if (!this.opts.multiExpand) {
	                ...
	                this.panels.forEach(function (panel, tab) {

	                    _this2.items.get(tab).classList.remove(_this2.opts.classItemActive);

	                    tab.classList.remove(_this2.opts.classTabActive);
	                    panel.classList.remove(_this2.opts.classPanelActive);

	                    setStatusAria(_this2.opts, tab, panel, false);

	                    if (_this2.opts.useAnimation) $(panel).slideUp();
	                });
	            }

	            var panel = this.panels.get(tab);
	            var item = this.items.get(tab);
	            ...
	            if (this.opts.setOddEven) {
	                ...
	                this.panels.forEach(function (panel, i) {
	                    if (panel.classList.contains(_this2.opts.classPanelActive)) {
...
/***/ (function(module, exports) {
	...
	_.setHeight = function (elem) {
	    ...
	    var _updateHeight = _.debounce(function () {
	        var clone = elem.cloneNode(true);
	        clone.style.cssText = "height: auto !important;";
	        clone.style.display = 'block', clone.style.position = 'absolute';
	    ...
	    function Toggler(target, opts) {
	        ...
	        Object.defineProperty(this, 'active', {
	            set: function set(newStatus) {
	                return active = newStatus ? changeState(true) : changeState(false);
	            },
	            get: function get() {
	                return active;
	            }
	        ...
	        var togglerSel = '[data-toggle="' + targetID + '"]';

	        var $target = $(target);
	        var $toggler = $(togglerSel);
	        ...
	        var closestFunc = function closestFunc(e) {
	        ...
	        var changeState = function changeState(state, first) {
	            ...
	            if (state) {
	                var $lazyList = $target.find('[data-lazy]');
	            ...
	            if (state && _this.opts.autoFocus) {
	                var focusElement = target.querySelector(_this.opts.autoFocus);
	                if (focusElement) {
	                    focusElement.focus();
	                }
	            }
	        ...
	        var isTargetActive = function isTargetActive() {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var MicroModal = function () {
	  ...
	  var init = function init(config) {
	    ...
	    var triggers = [].concat(_toConsumableArray(document.querySelectorAll('[data-micromodal-trigger]')));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Bee3D = function () {
	   ...
	   function e() {}function t(e) {
	      ...
	      var n;e = e || {};for (var i = 1; i < arguments.length; i++) {
	         n = Object(arguments[i]);for (var a in n) {
	            e[a] = t(n[a]) ? o(e[a], n[a]) : n[a];
	         }
	      }return e;
	   }function a() {
	      if (l.XMLHttpRequest) return new l.XMLHttpRequest();try {
	         return new l.ActiveXObject("MSXML2.XMLHTTP.3.0");
	      } catch (e) {}throw new Error("no xmlhttp request able to be created");
	   }function s(e, t, n) {
	      e[t] = e[t] || n;
	   }function r(e, t) {
	      this.options = o({}, u, t), this.init(e);
	   }var l = window,
	       c = document,
	       u = { wrapper: c.body, selector: ".bee3D--slide", effect: "coverflow", focus: 0, listeners: { keys: !1, touches: !1, clicks: !1, scroll: !1, drag: !1 }, navigation: { enabled: !1, next: ".bee3D--nav__next", prev: ".bee3D--nav__prev" }, ajax: { enabled: !1, path: null, when: 2, maxFetches: null, builder: function builder(e) {
	            return "<p>" + e.content + "</p>";
	         } }, autoplay: { enabled: !1, speed: 5e3, pauseHover: !1 }, loop: { enabled: !1, continuous: !1, offset: 2 }, sync: { enabled: !1, targets: [] }, parallax: { enabled: !1, className: "bee3D--parallax", friction: .7, settings: { relativeInput: !0, clipRelativeInput: !0, calibrateX: !0, calibrateY: !0, scalarX: 4, scalarY: 5, frictionX: .1, frictionY: .1 } }, shadows: { enabled: !1, template: ['<div class="bee3D--shadow-wrapper">', '<div class="bee3D--shadow">', "<span></span>", "</div>", "</div>"].join("") }, onInit: e, onChange: e, onDestroy: e },
	       f = function f(e, t) {
	      "string" == typeof e && (e = { url: e });var n = e.headers || {},
	          i = e.body,
	          o = e.method || (i ? "POST" : "GET"),
	          r = e.withCredentials || !1,
	          l = a();l.onreadystatechange = function () {
	         4 === l.readyState && t(l.status, l.responseText, l);
	      }, i && (s(n, "X-Requested-With", "XMLHttpRequest"), s(n, "Content-Type", "application/x-www-form-urlencoded")), l.open(o, e.url, !0), l.withCredentials = r;for (var c in n) {
	      ...
	      var e = this,
	         ...
	         var i = n.map(function (e) {
	            var t = c.createElement("section");return t.className = l, t.innerHTML = '<div class="bee3D--inner">' + a(e) + "</div>", u(t), t;
	         });return r = e.el.slides.length, e.slideEvents(i), t.maxFetches && o--, e.el.touch();
	      },
	          h = function h() {
	         f(i, function (e, t) {
	          ...
	          p = function p(e) {
	         if (r - n === e.index) {
	            if (!t.maxFetches) return h();if (o && o > 0) return h();
	         }
	      ...
	      for (var t = this, o = function o() {
	         var n = e.indexOf(this);return t.el.slide(n);
	      }, a = 0; a < e.length; a++) {
	         e[a].style.pointerEvents = "auto", e[a].style.cursor = "pointer", n(e[a], "click", o);
	         ...
	         e.forEach(function (e) {
	            e.removeAttribute("style"), i(e, "click", o);
	         });
	      });
	   },
	       v = function v() {
	      var e = this.el;e.on("prev", function (t) {
	      ...
	      };classie.add(a, "draggable"), n(a, "mousedown", s), n(a, "mousemove", r), n(a, "mouseup", l), this.el.on("destroy", function () {
	         classie.remove(a, "draggable"), i(a, "mousedown", s), i(a, "mousemove", r), i(a, "mouseup", l);
	      });
	   },
	       b = function b() {
	      var e = this,
	          t = this.el.parent,
	          o = function o(t) {
	         var n = t.wheelDelta || -t.detail;return n < 0 ? e.el.next() : e.el.prev();
	      };n(t, "mousewheel DOMMouseScroll", o), this.el.on("destroy", function () {
	      ...
	      var e = this,
	         ...
	         n(i, "click", function (t) {
	            return t.preventDefault(), _o ? e.el.next() : e.el.prev();
	         }), t.autoplay.enabled && t.autoplay.pauseHover && e.listenToHover(i);
	      },
	          a = i.querySelector(t.navigation.prev),
	          s = i.querySelector(t.navigation.next);s && o(s, !0), a && o(a, !1);
	   },
	       x = function x(e) {
	      if (l.Parallax) {
	         for (var t = this, n = t.options, i = n.shadows.enabled, o = n.parallax.className, a = n.parallax.friction, s = n.parallax.settings, r = function r(e) {
	            classie.add(e, o), e.setAttribute("data-depth", a);
	         }, c = 0; c < e.length; c++) {
	            var u = e[c];r(u.firstElementChild), i && r(u.lastChild);
	            ...
	            t.el.parent.removeAttribute("style"), t._parallax.disable();var e = t._parallax.layers;t._parallax = t._parallax.layers = t._parallax.element = void 0;for (var n = e.length - 1; n >= 0; n--) {
	               var i = e[n];classie.remove(i, o), i.removeAttribute("data-depth"), i.removeAttribute("style");
	            }
	         });
	      }
	   },
	       g = function g(e) {
	      var t = this.options.shadows.template;e.forEach(function (e) {
	         e.innerHTML += t;
	      }), this.el.on("destroy", function () {
	         e.forEach(function (e) {
	      ...
	      var e = this.options.sync.targets,
	          t = function t(_t) {
	         for (var n = _t.index, i = 0; i < e.length; i++) {
	            l[e[i]].el.slide(n);
	         }
	      ...
	      return function (t) {
	         var o = "vertical" !== e,
	             a = function a(e) {
	            (34 === e.which || 32 === e.which || o && 39 === e.which || !o && 40 === e.which) && t.next(), (33 === e.which || o && 37 === e.which || !o && 38 === e.which) && t.prev();
	         };n(c, "keydown", a), t.on("destroy", function () {
	            i(c, "keydown", a);
	         });
	      };
	   },
	      ...
	      var t = "bee3D--",
	          n = e.loop.continuous,
	          i = e.loop.offset;return function (o) {
	         var a = o.slides.length,
	            ...
	            var l = o.slide(),
	                c = t - l,
	                u = c > 0 ? "after" : "before";if (n) {
	               var f = a - i - 1;c >= f && (u = "before", c = a - c), c <= -f && (u = "after", c = a + c);
	            }["before(-\\d+)?", "after(-\\d+)?", "slide__active", "slide__inactive"].map(r.bind(null, e)), t !== l && ["slide__inactive", u, u + "-" + Math.abs(c)].map(s.bind(null, e));
	         };s(o.parent, "parent"), ".bee3D--slide" !== !e.slideSelector && o.slides.forEach(function (e) {
	            s(e, "slide");
	         }), o.on("activate", function (e) {
	            o.slides.map(l), s(e.slide, "slide__active"), r(e.slide, "slide__inactive");
	         });
	      };
	   },
	       E = function E(e) {
	      return function (e) {
	         function t(e) {
	            s = e.touches[0].pageX, r = e.touches[0].pageY, l = 0;
	         }function o(e) {
	            var t = e.touches[0];if (Math.abs(s - t.pageX) > Math.abs(r - t.pageY)) return l = t.pageX - s, !1;
	         }function a() {
	            Math.abs(l) > 50 && e[l > 0 ? "prev" : "next"]();
	         }var s,
	             r,
	             l,
	             c = e.parent;n(c, "touchstart", t), n(c, "touchmove", o), n(c, "touchend", a), e.on("destroy", function () {
	            i(c, "touchstart", t), i(c, "touchmove", o), i(c, "touchend", a);
	         });
	      };
	   },
	       M = function M(e) {
	      ...
	      var t = [].slice.call(e),
	         ...
	         return s("activate", a(n, e));
	          ...
	          l = function l(e, i) {
	         t[e] && (s("deactivate", a(n, i)), n = t[e], r(i));
	      },
	          c = function c(e, n) {
	         var i = o();if (i !== e) return arguments.length ? (s("slide", a(t[e], n)), void l(e, n)) : i;
	      },
	          u = function u(e, i) {
	         var o = t.indexOf(n) + e;s(e > 0 ? "next" : "prev", a(n, i)), l(o, i);
	      },
	          f = function f(e, t) {
	         return i[e] = (i[e] || []).concat(t), function () {
	            i[e] = i[e].filter(function (e) {
	               return e !== t;
	            });
	         };
	      };return { on: f, fire: s, touch: r, slide: c, next: u.bind(null, 1), prev: u.bind(null, -1), slides: t };
	   },
	       H = function H(e) {
	      function t() {
	      ...
	      }var a = this;n(e, "mouseover", t), n(e, "mouseout", o), a.el.on("destroy", function () {
	         i(e, "mouseover", o), i(e, "mouseout", t);
	      });
	   },
	       S = function S() {
	      var e = this.el.parent,
	          t = this.el.slides,
	          n = new RegExp("bee3D-(.*)", "g");e.className = e.className.replace(n, "");for (var i = ".bee3D--slide" === this.options.selector, o = 0; o < t.length; o++) {
	         t[o].className = i ? "bee3D--slide" : t[o].className.replace(n, "");
	      }this.el.fire("destroy");var a = this.options.onDestroy;this.options = u, this.plugins(), a();
	   };return r.prototype = { init: function init(e) {
	         var t = this.options,
	             n = e.querySelectorAll(t.selector);this.el = k(n), this.el.parent = e, this.plugins(), this.el.slide(this.options.focus), classie.add(this.el.parent, "bee3D--effect__" + this.options.effect), this.events(), this.slideEvents(), this.options.onInit(), this.el.initialized = !0;
	      }, plugins: function plugins() {
	         var e = this,
	             t = e.options,
	             n = [_(t), M(t.onChange)];t.listeners.keys && n.push(D()), t.listeners.touches && n.push(E()), (n || []).forEach(function (t) {
	            t(e.el);
	         });
	      }, events: function events() {
	         var e = this.options;e.sync.enabled && this.sync(), e.ajax.enabled && this.ajax(), e.loop.enabled && this.loop(), e.autoplay.enabled && this.autoplay(), e.navigation.enabled && this.navigation(), e.listeners.scroll && this.mouseScroll(), e.listeners.drag && this.mouseDrag();
	      }, slideEvents: function slideEvents(e) {
	         var t = this.options;e || (e = this.el.slides), t.shadows.enabled && this.shadows(e), t.parallax.enabled && this.parallax(e), t.listeners.clicks && this.clickInactives(e);
	      }, sync: w, ajax: d, loop: v, shadows: g, autoplay: h, navigation: y, parallax: x, clickInactives: p, mouseScroll: b, mouseDrag: m, destroy: S, listenToHover: H }, r;
	}();
